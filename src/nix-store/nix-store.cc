    ...
    while (true) {
        ...
        switch (cmd) {
            ...
            case cmdQueryValidPaths: {
                ...
                auto paths = serve_proto::read(*store, clientVersion, in, Phantom<StorePathSet> {});
                ...
                serve_proto::write(*store, clientVersion, out, store->queryValidPaths(paths));
                break;
            }
            ...
            case cmdQueryPathInfos: {
                ...
                for (auto & i : paths) {
                    try {
                        ...
                        serve_proto::write(*store, clientVersion, out, info->references);
            ...
            case cmdExportPaths: {
                readInt(in); // obsolete
                store->exportPaths(serve_proto::read(*store, clientVersion, in, Phantom<StorePathSet> {}), out);
                break;
            }
            ...
            case cmdQueryClosure: {
                ...
                store->computeFSClosure(serve_proto::read(*store, clientVersion, in, Phantom<StorePathSet> {}),
                    closure, false, includeOutputs);
                serve_proto::write(*store, clientVersion, out, closure);
                break;
            }
            ...
            case cmdAddToStoreNar: {
                ...
                info.references = serve_proto::read(*store, clientVersion, in, Phantom<StorePathSet> {});
